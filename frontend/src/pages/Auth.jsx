      ...
      >
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-200 rounded-lg py-3 hover:bg-gray-50 transition-colors font-medium text-gray-700 shadow-sm"
          >
          ...
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-200 rounded-lg py-3 hover:bg-gray-50 transition-colors font-medium text-gray-700 shadow-sm"
          >
            <div className="w-[18px] h-[18px] bg-[#0068ff] rounded-md text-white flex items-center justify-center text-[10px] font-bold">
              Zalo
            </div>
            Zalo
          </button>
