  ...
  const cards = [
    {
      ...
      tag: 'Pin',
      headline: '33 giờ',
      sub: 'xem video. Bước nhảy vọt lớn nhất về thời lượng pin từ trước đến nay.',
      color: '#e2e2e5', // Silver/white
    },
    {
      id: 'chip',
      type: 'chip',
    ...
    },
    {
      ...
      headline: '48MP',
      sub: 'Camera Fusion, Siêu rộng 48MP và Telephoto 5x.',
      color: '#e5e5ea',
    },
    {
      id: 'camera-control',
      type: 'feature',
      tag: 'Điều khiển Camera',
      headline: 'Mượt mà',
      sub: 'Một cách thức mới để truy cập nhanh các công cụ camera như thu phóng và độ sâu trường ảnh.',
      color: '#f2f2f7',
    },
    {
      id: 'build',
      ...
      tag: 'Thiết kế',
      headline: 'Titan',
      sub: 'Hoàn thiện Titan Trắng. Thiết kế titan chuẩn hàng không vũ trụ. Vô cùng bền bỉ và mỏng nhẹ.',
      color: '#ffffff',
    }
  ];
