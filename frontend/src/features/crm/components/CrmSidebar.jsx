...
const CrmSidebar = ({ user, onLogout }) => {
  ...
  return (
    <aside className="w-64 h-screen bg-[#090a0f] border-r border-white/10 text-white flex flex-col justify-between fixed top-0 left-0 z-40 select-none">
      <div>
        {/* Brand Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            <div className="truncate">
              <p className="text-xs font-semibold text-white truncate">{user?.fullName || 'Tài khoản CRM'}</p>
