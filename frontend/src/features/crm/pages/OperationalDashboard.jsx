    ...
    <div className="space-y-8 w-full">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-xs text-white transition-colors"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Card 1: Total Leads */}
        <div className="p-5 rounded-xl bg-[#12141d] border border-white/10 flex flex-col justify-between">
          <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-xl bg-[#12141d] border border-white/10 flex flex-col justify-between">
          ...
          <div className="mt-4">
            <div className="text-2xl font-bold text-white">{stats.newLeadsLast7Days}</div>
        ...
        <div className="p-5 rounded-xl bg-[#12141d] border border-white/10 flex flex-col justify-between">
          ...
          <div className="mt-4">
            <div className="text-2xl font-bold text-white">{stats.wonDealsCount}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-6 rounded-xl bg-[#12141d] border border-white/10">
          <h3 className="text-sm font-semibold text-white mb-4">Lượng Leads Theo Thời Gian</h3>
        ...
        <div className="p-6 rounded-xl bg-[#12141d] border border-white/10 flex flex-col justify-between">
          <h3 className="text-sm font-semibold text-white mb-2">Phân Bổ Theo Nguồn Lead</h3>
          ...
          <div className="grid grid-cols-2 gap-2 mt-2 pt-3 border-t border-white/10">
            {sourceChart.map((src, i) => (
              <div key={src.source} className="flex items-center gap-2 text-xs">
                ...
                <span className="font-semibold text-white ml-auto">{src.count}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="p-6 rounded-xl bg-[#12141d] border border-white/10">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white">Cần Follow-Up Ngay Hôm Nay</h3>
              ...
              {followUpToday.length === 0 ? (
                ...
                followUpToday.map((lead) => (
                  <tr key={lead.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-bold text-white">{lead.score} điểm</td>
