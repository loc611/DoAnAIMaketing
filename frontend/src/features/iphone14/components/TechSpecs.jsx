  ...
  const cards = [
    {
      ...
      tag: 'Pin',
      headline: '29 giờ',
      sub: 'xem video. Thời lượng pin đỉnh cao.',
      color: '#ff9c3f',
    },
    {
      id: 'chip',
      ...
      tag: 'Chip A16 Bionic',
      headline: '16 lõi',
      sub: 'Neural Engine. CPU 6 lõi, GPU 5 lõi.',
      color: '#6fb8ff',
    },
    {
      id: 'display',
    ...
    },
    {
      ...
      headline: '48MP',
      sub: 'Chính, Siêu rộng, và Tele. Zoom quang học 3x.',
      color: '#ffcf5c',
    },
    {
      id: 'storage',
      ...
      <div className="relative z-10 w-full px-6 sm:px-12 lg:px-24 mx-auto max-w-[1400px]">
        ...
        >
          ...
          <p className="mt-4 text-[#f4f4f3]/60 text-[15.5px] max-w-[46ch] mx-auto">
            Chiếc iPhone tối thượng. Dành cho các chuyên gia.
          </p>
        </motion.div>
      ...
      {isBattery && (
        <div className="relative w-[96px] h-[96px] shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-xl font-black font-mono text-[#f4f4f3]">29</span>
          </div>
        </div>
      )}
